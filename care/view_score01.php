...
// 查詢問題文字
$questions_sql = "SELECT id, question_text FROM question01 WHERE id BETWEEN 1 AND 6";
...
// 查詢篩選後的成績
$sql = "SELECT * FROM dive_test_v2 WHERE UserID = ?";
...
<head>
    <meta charset="UTF-8">
    <title>查看手動腹膜透析的成績 - <?php echo htmlspecialchars($username_filter); ?></title>
